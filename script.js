...
const itemsChecklist = [
    ...
    { id: 'maquillaje', texto: 'Maquillaje', tipo: 'radio', opciones: ['Maquillado', 'Sí', 'No', 'N/A'], icon: 'fa-solid fa-palette', indicator: true },
